...
|场景|演示|样例|
|:---|:---:|:---|
|栈管理（同级、多层嵌套）|<img src="/images/start.gif" width = "200" height = "355" alt="start"/>|[StartFragment.java](/app/src/main/java/com/yj/app/test/start/StartFragment.java)
|同级展示|<img src="/images/show.gif" width = "200" height = "355" alt="start"/>|[ShowFragment.java](/app/src/main/java/com/yj/app/test/show/ShowFragment.java)
|同级替换|<img src="/images/replace.gif" width = "200" height = "355" alt="start"/>|[ReplaceFragment.java](/app/src/main/java/com/yj/app/test/replace/ReplaceFragment.java)
|懒加载|<img src="/images/lazyload.gif" width = "200" height = "355" alt="start"/>|[LazyLoadFragment.java](/app/src/main/java/com/yj/app/test/lazyload/LazyLoadFragment.java)
