...
|场景|演示|样例|
|:---|:---:|:---|
|栈管理（同级、多层嵌套）|<img src="/images/start.gif" width = "300" height = "535" alt="start" align=center />|[StartFragment.java](/app/src/main/java/com/yj/app/test/start/StartFragment.java)
|同级展示|<img src="/images/show.gif" width = "300" height = "535" alt="start" align=center />|[ShowFragment.java](/app/src/main/java/com/yj/app/test/show/ShowFragment.java)
|同级替换|<img src="/images/replace.gif" width = "300" height = "535" alt="start" align=center />|[ReplaceFragment.java](/app/src/main/java/com/yj/app/test/replace/ReplaceFragment.java)
|懒加载|<img src="/images/lazyload.gif" width = "300" height = "535" alt="start" align=center />|[LazyLoadFragment.java](/app/src/main/java/com/yj/app/test/lazyload/LazyLoadFragment.java)
