 ...
 *
 * @author JingYeoh <a href="mailto:yangjing9611@foxmail.com">Email me</a>
...
public class Logger {
     ...
     * Send an {@link Log#INFO} log message.
     *
     * @param clz Get the class's simple name and Used to identify the source of a log message.  It usually identifies
     *            the class or activity where the log call occurs.
     * @param msg The message you would like logged.
     */
     ...
     * Send an {@link Log#DEBUG} log message.
     *
     * @param object Get the object's class name and Used to identify the source of a log message.  It usually
     *               identifies
     *               the class or activity where the log call occurs.
     * @param msg    The message you would like logged.
     */
